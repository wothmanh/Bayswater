                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <form method="POST" action="{{ route('admin.prices.update', $price) }}">
                        ...
                        <div class="mb-4">
                            ...
                            <x-text-input id="price_per_week_2026" class="block mt-1 w-full" type="number" step="0.01" name="price_per_week_2026" :value="old('price_per_week_2026', $price->price_per_week_2026)" min="0" />
