                    ...
                    <form method="POST" action="{{ route('admin.discount-rules.store') }}">
                            ...
                            <div class="md:col-span-2">
                                ...
                                <div class="mt-3">
                                    <label for="hide_rule_name_in_calculator" class="inline-flex items-center">
                                        <input id="hide_rule_name_in_calculator" type="checkbox" class="rounded dark:bg-gray-900 border-gray-300 dark:border-gray-700 text-indigo-600 shadow-sm focus:ring-indigo-500 dark:focus:ring-indigo-600 dark:focus:ring-offset-gray-800" name="hide_rule_name_in_calculator" value="1" {{ old('hide_rule_name_in_calculator') ? 'checked' : '' }}>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                             ...
                             <div>
                                 ...
                                 <x-text-input id="nationality_title" class="block mt-1 w-full" type="text" name="nationality_title" :value="old('nationality_title')" placeholder="e.g., Saudi National Day Offer" />
                                ...
                                <select name="specific_course_ids[]" id="specific_course_ids" class="block mt-1 w-full border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm" multiple size="5">
                                    @foreach($courses as $course)
                                        <option value="{{ $course->id }}" 
                                            ...
                                            {{ in_array($course->id, old('specific_course_ids', [])) ? 'selected' : '' }}>
                                            {{ $course->name }}
                                        </option>
                                    @endforeach
                                </select>
                             ...
                             <div>
                                 ...
                                 <x-text-input id="quotation_extraction_date_from" class="block mt-1 w-full" type="date" name="quotation_extraction_date_from" :value="old('quotation_extraction_date_from')" />
                             ...
                             <div>
                                 ...
                                 <x-text-input id="quotation_extraction_date_to" class="block mt-1 w-full" type="date" name="quotation_extraction_date_to" :value="old('quotation_extraction_date_to')" />
