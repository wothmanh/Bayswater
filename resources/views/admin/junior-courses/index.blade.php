        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <div class="overflow-x-auto">
                        <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                            ...
                            @include('admin.junior-courses._index_rows')
                        </tbody>
                    </table>
                </div>
                ...
                <div id="pagination-container" class="mt-4">
                    @include('admin.junior-courses._pagination')
                </div>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
            ...
            if (rowsContainer && !rowsContainer.dataset.sortableInit) {
                const sortable = Sortable.create(rowsContainer, {
                    ...
                    onEnd: function(evt) {
                        ...
                        fetch('{{ route("admin.junior-courses.update-order") }}', {
                            method: 'POST',
                            headers: {
        ...
        function fetchCourses(pageUrl = null) {
            const baseUrl = pageUrl ? new URL(pageUrl, window.location.origin) : new URL('{{ route("admin.junior-courses.filter") }}', window.location.origin);
